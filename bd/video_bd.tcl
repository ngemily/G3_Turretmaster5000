...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.C_ALL_INPUTS {1} CONFIG.C_GPIO_WIDTH {5} CONFIG.C_INTERRUPT_PRESENT {1} CONFIG.GPIO_BOARD_INTERFACE {Custom} CONFIG.USE_BOARD_FLOW {true}  ] $axi_gpio_0
...
CONFIG.G_USE_EXCEPTIONS {1}  ] $microblaze_0
  ...
  set_property -dict [ list CONFIG.NUM_MI {6} CONFIG.NUM_SI {1}  ] $microblaze_0_axi_periph
